...
COPY %SOURCE%icon-256x256.png %TARGET% >NUL
COPY %SOURCE%appinfo.json %TARGET% >NUL
...
REM create palm-package.bat
title Deploy - Palm package step
ECHO =================================
ECHO Write ( palm-package "%DEPLOY%" ) 
ECHO To ( "..\deploy\package.bat" )
ECHO =================================
ECHO palm-package "%DEPLOY%" > "..\deploy\package.bat"
