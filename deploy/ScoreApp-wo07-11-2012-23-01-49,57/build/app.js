...
enyo.path.addPaths({layout: "I://Prive/equus_quagga/ScoreApp/enyo/tools/../../lib/layout/", onyx: "I://Prive/equus_quagga/ScoreApp/enyo/tools/../../lib/onyx/", onyx: "I://Prive/equus_quagga/ScoreApp/enyo/tools/../../lib/onyx/source/", webOS: "I://Prive/equus_quagga/ScoreApp/enyo/tools/../../lib/webOS/"});
...
enyo.webOS.keyboard.setManualMode(!0), PalmSystem.keyboardShow(inType || 0);
},
forceHide: function() {
...
n.initEvent(e, !0, !0), typeof t != "undefined" && (n.windowParams = t), document.dispatchEvent(n);
};
...
var t = {};
try {
t = enyo.json.parse(PalmSystem.launchParams);
} catch (n) {
enyo.error("applicationLaunch windowParams object is not valid JSON");
}
return e("applicationrelaunch", t), !0;
}, enyo.dispatcher.listen(document, "windowactivated"), enyo.dispatcher.listen(document, "windowdeactivated"), enyo.dispatcher.listen(document, "windowhidden"), enyo.dispatcher.listen(document, "windowshown"), enyo.dispatcher.listen(document, "applicationrelaunch");
})();
...
components: [ {
kind: "Signals",
onapplicationrelaunch: "applicationrelaunch"
}, {
kind: "Signals",
onwindowdeactivated: "requestAppMenuHide"
} ],
getScrim: function() {
return onyx.scrimTransparent.make();
},
requestAppMenuShow: function() {
return this.setShowing(!0), !0;
},
requestAppMenuHide: function() {
return this.setShowing(!1), !0;
},
toggle: function() {
return this.showing ? (this.requestAppMenuHide(), !1) : (this.requestAppMenuShow(), !0);
},
applicationrelaunch: function(e, t) {
t.windowParams["palm-command"] == "open-app-menu" && this.toggle();
}
});
...
name: "aboutid",
content: "-Equus Quagga-",
allowHtml: !0,
classes: "version"
}, {
kind: "enyo.Image",
src: "assets/eqlogo.png",
style: "position: absolute; right:-40px;bottom:-40px;"
}, {
content: "A bootplate for webOS applications made by Equus Quagga",
allowHtml: !0,
classes: "aboutinfo"
} ],
create: function() {
this.inherited(arguments), window.PalmSystem && this.$.loader.send();
},
processResponse: function(e, t) {
this.appinfo = t.data, this.$.abouttitle.setContent(this.appinfo.title), this.$.aboutversion.setContent("VERSION:" + this.appinfo.version), this.$.aboutid.setContent("ID: " + this.appinfo.id), this.$.abouticon.setSrc(this.appinfo.icon);
}
});
...
content: "Voeg een nieuw spel toe",
allowHtml: !0,
classes: "version"
}, {
classes: "spelline"
...
components: [ {
kind: "enyo.Image",
src: "assets/ico_addblue.png",
style: "position: absolute; left:-10px;top:-10px;"
}, {
content: "Nieuwe Speler",
allowHtml: !0,
classes: "head"
}, {
content: "Voeg een nieuwe speler toe",
allowHtml: !0,
classes: "version"
}, {
classes: "spelerline"
...
components: [ {
kind: "enyo.Image",
src: "assets/ico_addblack.png",
style: "position: absolute; left:-10px;top:-10px;"
}, {
content: "Nieuw Potje gespeeld",
allowHtml: !0,
classes: "head"
}, {
content: "Voeg een nieuw potje",
allowHtml: !0,
classes: "version"
}, {
...
components: [ {
kind: "enyo.Image",
src: "assets/ico_addpurple.png",
style: "position: absolute; left:-10px;top:-10px;"
}, {
content: "Nieuw Filter",
allowHtml: !0,
classes: "head"
}, {
content: "Voeg een nieuw Filter toe",
allowHtml: !0,
classes: "version"
}, {
classes: "filterline"
...
name: "nieuweSpelerPop",
kind: "nieuweSpeler"
}, {
name: "nieuwGespeeldPop",
kind: "nieuwGespeeld"
}, {
name: "nieuwFilterPop",
kind: "nieuwFilter"
...
kind: "FittableRows",
name: "linkerPaneel",
classes: "linkerPaneel",
components: [ {
kind: "onyx.Toolbar",
classes: "headers onyx-toolbar-inline",
components: [ {
kind: "onyx.RadioGroup",
name: "linkerKeuze",
style: "margin:-1px 0 0 0;width:100%;",
onActivate: "updateLinkerPaneel",
components: [ {
content: "Spellen",
name: "spellenKeuze",
style: "width:33%;",
...
content: "Alles",
kind: "onyx.Button",
ontap: "selectAllSpellen",
classes: "buttonGroen selectButton"
}, {
content: "Niets",
kind: "onyx.Button",
ontap: "selectNoneSpellen",
classes: "buttonGroen selectButton"
}, {
content: "Wissel",
kind: "onyx.Button",
ontap: "selectInvertSpellen",
classes: "buttonGroen selectButton"
} ],
classes: "spellistitem",
name: "AllSpellen"
...
content: "Alles",
kind: "onyx.Button",
ontap: "selectAllSpelers",
classes: "buttonBlauw selectButton"
}, {
content: "Niets",
kind: "onyx.Button",
ontap: "selectNoneSpelers",
classes: "buttonBlauw selectButton"
}, {
content: "Wissel",
kind: "onyx.Button",
ontap: "selectInvertSpelers",
classes: "buttonBlauw selectButton"
} ],
classes: "spelerlistitem",
name: "AllSpelers"
...
components: [ {
content: "Nieuw Potje",
classes: "gespeeldnaam"
}, {
kind: "Image",
src: "assets/ico_addblack.png",
classes: "addbutton"
} ],
classes: "gespeeldlistitem",
ontap: "nieuwGespeeld"
}, {
components: [ {
content: "Alles",
kind: "onyx.Button",
ontap: "selectAllGespeeld",
classes: "buttonZwart selectButton"
}, {
content: "Niets",
kind: "onyx.Button",
ontap: "selectNoneGespeeld",
classes: "buttonZwart selectButton"
}, {
content: "Wissel",
kind: "onyx.Button",
ontap: "selectInvertGespeeld",
classes: "buttonZwart selectButton"
} ],
classes: "gespeeldlistitem",
name: "AllGespeeld"
...
rendered: function() {
this.inherited(arguments), this.populateSpelList(), this.populateSpelerList(), this.populateFilterList();
},
updateLinkerPaneel: function(e, t) {
t.originator.getActive() && this.$.linkerlijsten.setIndex(t.originator.value);
},
populateSpelList: function() {
this.$.SpelList.setCount(this.defaultspellen.length), this.$.SpelList.setRowsPerPage(20), this.$.SpelList.reset();
},
setupSpelItem: function(e, t) {
var n = t.index, r = this.defaultspellen[n];
this.$.SpelItem.setSpel(r), this.$.SpelItem.setSelected(e.isSelected(n));
},
selectAllSpellen: function() {
for (i = 0; i < this.$.SpelList.count; i++) this.$.SpelList.deselect(i), this.$.SpelList.select(i);
},
selectNoneSpellen: function() {
for (i = 0; i < this.$.SpelList.count; i++) this.$.SpelList.deselect(i);
},
selectInvertSpellen: function() {
for (i = 0; i < this.$.SpelList.count; i++) this.$.SpelList.select(i);
},
selectAllSpelers: function() {
for (i = 0; i < this.$.SpelerList.count; i++) this.$.SpelerList.deselect(i), this.$.SpelerList.select(i);
},
selectNoneSpelers: function() {
for (i = 0; i < this.$.SpelerList.count; i++) this.$.SpelerList.deselect(i);
},
selectInvertSpelers: function() {
for (i = 0; i < this.$.SpelerList.count; i++) this.$.SpelerList.select(i);
},
populateSpelerList: function() {
this.$.SpelerList.setCount(this.avatars.length), this.$.SpelerList.setRowsPerPage(20), this.$.SpelerList.reset();
},
setupSpelerItem: function(e, t) {
var n = t.index, r = this.avatars[n];
this.$.SpelerItem.setSpeler(r), this.$.SpelerItem.setSelected(e.isSelected(n));
},
populateFilterList: function() {
this.$.FilterList.setCount(this.defaultfilters.length), this.$.FilterList.setRowsPerPage(20), this.$.FilterList.reset();
},
setupFilterItem: function(e, t) {
var n = t.index, r = this.defaultfilters[n];
this.$.FilterItem.setFilter(r), this.$.FilterItem.setSelected(e.isSelected(n));
},
about: function(e, t) {
this.$.appMenu.hide(), this.$.AboutPop.show();
},
nieuwSpel: function(e, t) {
this.$.appMenu.requestAppMenuHide(), this.$.nieuwSpelPop.show();
},
nieuweSpeler: function(e, t) {
this.$.appMenu.requestAppMenuHide(), this.$.nieuweSpelerPop.show();
},
nieuwFilter: function(e, t) {
this.$.appMenu.requestAppMenuHide(), this.$.nieuwFilterPop.show();
},
nieuwGespeeld: function(e, t) {
this.$.appMenu.requestAppMenuHide(), this.$.nieuwGespeeldPop.show();
},
windowactivated: function(e, t) {},
windowdeactivated: function(e, t) {},
editTap: function(e, t) {},
defaultspellen: [ {
naam: "Afrika",
icon: "afrika.jpg",
spelers: "2-4",
...
name: "waardering",
kind: "Image",
classes: "spelwaardering"
}, {
name: "highscore",
classes: "spelhighscore"
}, {
name: "aantal",
classes: "spelaantal"
}, {
...
setSpel: function(e) {
this.$.naam.setContent(e.naam), this.$.icon.setSrc("assets/spellen/" + e.icon), this.$.highscore.setContent("HS: " + e.highscore), this.$.spelers.setContent("Spelers: " + e.spelers), this.$.tijd.setContent("Tijd: " + e.tijd), this.$.waardering.setSrc("assets/star" + e.waardering + ".png"), this.$.aantal.setContent("Aantal: " + e.aantal + "x"), this.$.laatst.setContent(e.laatst);
},
setSelected: function(e) {
this.addRemoveClass("spelselected", e);
}
}), enyo.kind({
name: "SpelerItem",
classes: "spelerlistitem",
...
name: "speleraantal",
classes: "speleraantal"
}, {
name: "spelerlaatst",
classes: "spelerdatum"
} ],
setSpeler: function(e) {
this.$.spelericon.setSrc("assets/avatars/48/" + e), this.$.spelernaam.setContent(e), this.$.speleraantal.setContent("Aantal: 7x"), this.$.spelerlaatst.setContent(e);
},
setSelected: function(e) {
this.addRemoveClass("spelerselected", e);
}
}), enyo.kind({
name: "FilterItem",
classes: "filterlistitem",
...
this.$.filternaam.setContent(e.naam), this.$.filterlaatst.setContent(e.laatst);
},
setSelected: function(e) {
this.addRemoveClass("filterselected", e);
}
});
